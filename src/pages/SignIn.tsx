...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, Shield, Zap, Heart } from "lucide-react";
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-white/80 max-w-md">
                Join thousands of happy customers who shop with confidence on our trusted marketplace.
              </p>
            </div>
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 h-12 rounded-xl bg-secondary/50 border-transparent focus:border-primary focus:bg-background transition-colors"
                      required={!isLogin}
                    />
                  </div>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className="pl-12 pr-12 h-12 rounded-xl bg-secondary/50 border-transparent focus:border-primary focus:bg-background transition-colors"
                    required
                  />
                  <button
                    type="button"
              ...
              <Button
                type="submit"
                size="lg"
                className="w-full h-12 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-semibold shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300"
                disabled={isLoading}
              >
                {isLoading ? (
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button
                type="button"
                variant="outline"
                className="h-12 rounded-xl border-border hover:bg-secondary/80 transition-colors"
              >
